...
Minimal CLI inference:
    ...
    python predict.py --folder drive/features_slr/42/
"""
import argparse
...
def main():
    ...
    group.add_argument("--pt",     type=str, help="Single .pt feature file")
    group.add_argument("--folder", type=str, help="Folder of .pt feature files for one sample")
